...
import{ArrowDownLeft,ArrowLeft,Building2,ChevronRight,CreditCard,Eye,EyeOff,History,QrCode,Send,Smartphone,UploadCloud,WalletCards}from'lucide-react';
...
export default function WalletAction({action}:{action:Action}){
  ...
  return <div className="mx-auto max-w-xl p-4 pb-28 md:p-8">
    ...
    <SecurityConfirmModal open={secure.open} busy={secure.busy} onClose={secure.close} onConfirm={secure.confirm} onBiometric={secure.biometric} title="Accès protégé" subtitle="Entrez le code secret de l'application pour afficher les informations sensibles. Ce code ne confirme aucune transaction."/>
  </div>;
}
