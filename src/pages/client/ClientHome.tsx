...
export default function ClientHome(){
  ...
  useEffect(()=>{
    ...
    localCardPairService.ensure().catch(error=>console.warn('[LOCAL_CARD_PAIR_PROVISION_WARNING]',error));
  ...
  return <div className="mx-auto max-w-5xl space-y-5 p-4 pb-28 md:p-8">
    ...
    <SecurityConfirmModal open={securityOpen} busy={securityBusy} onClose={()=>!securityBusy&&setSecurityOpen(false)} onConfirm={confirmReveal} title="Afficher mon solde" subtitle="Entrez le PIN de l’application pour afficher le solde et votre identifiant Market-Cash."/>
  </div>;
}
