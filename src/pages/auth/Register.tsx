...
export default function Register(){
 ...
 if(isAuthenticated&&user){if(!user.phone?.trim())return <ProfileSetup/>;return <Navigate to={next||getHomeRouteByRole(user.role)} replace/>}
